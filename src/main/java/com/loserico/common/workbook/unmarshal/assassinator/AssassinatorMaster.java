package com.loserico.common.workbook.unmarshal.assassinator;

import com.loserico.common.workbook.exception.AssassinationTrainFailedException;
...
import static com.loserico.common.workbook.utils.ExcelUtils.stringVal;
	...
	public RowIterator train(List<POJOAssassinator> assassinators, Workbook workbook) {
		...
		if (this.titleRowIndex != -1) {
			...
			while (iterator.hasNext()) {
				...
				String title = stringVal(titleRow.getCell(0));
				if (isNotBlank(title)) {
